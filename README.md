...
<body> mein webpage ke visible elements rakhe jate hain.
3. Heading
...
6. JavaScript mein Input ko Select Karna
...
7. JavaScript mein Button ko Select Karna
...
Click event detect hota hai.
Click handler execute hota hai.
Input ki current value read hoti hai.
Value alert mein show hoti hai.
9. .value — First Method
...
14. The Challenge — Input Clear Karna
